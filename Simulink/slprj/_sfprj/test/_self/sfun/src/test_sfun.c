  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3346052365U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3722152868U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1958268708U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3924414370U);
  }
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "y8w1LFM3cZrVokbizL8k8E") == 0) {
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "ndCWTLtRYoTO1ClJ8vxqCD") == 0) {
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "ndCWTLtRYoTO1ClJ8vxqCD") == 0) {
          extern mxArray *sf_c2_test_updateBuildInfo_args_info(void);
          plhs[0] = sf_c2_test_updateBuildInfo_args_info();
          break;
        }
      }
