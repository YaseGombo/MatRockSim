...
static void sf_gateway_c2_test(SFc2_testInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_u, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  c2_chartNumber, uint32_T c2_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, c2_instanceNumber, 0U,
    sf_debug_get_script_id("/home/ikemoto/MatRockSim/Simulink/testfunc.m"));
}
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("testfunc"), "name", "name", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]/home/ikemoto/MatRockSim/Simulink/testfunc.m"), "resolved", "resolved",
                  0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1403362174U), "fileTimeLo",
                  "fileTimeLo", 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4050216491U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2295994182U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2853485513U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3924888878U);
}
...
mxArray *sf_c2_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("y8w1LFM3cZrVokbizL8k8E");
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_testInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_SCRIPT_FCN(0,0,"testfunc",0,-1,38);
...
extern void sf_internal_set_sim_state_c2_test(SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_test();/* state var info */
...
static void mdlSetWorkWidths_c2_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2650522639U));
  ssSetChecksum1(S,(3637871458U));
  ssSetChecksum2(S,(964926772U));
  ssSetChecksum3(S,(886723517U));
